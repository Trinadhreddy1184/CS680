...
public class LinkTest {
    ...
    private String[] linkToStringArray(umbcs680.hw12.filesystemcomparator.Link l){
    ...
    private String[] linkTargetFileToStringArray(umbcs680.hw12.filesystemcomparator.File f){
    ...
    public void linkCheck(){
        ...
        umbcs680.hw12.filesystemcomparator.Link readme = test.getLinks().get(0);
    ...
    public void linkTargetEqualityCheck(){
        ...
        Directory src = repo.getSubDirectories().getFirst();
        Directory test = src.getSubDirectories().get(1);
        umbcs680.hw12.filesystemcomparator.File readme = (umbcs680.hw12.filesystemcomparator.File) test.getLinks().get(0).getTarget();
