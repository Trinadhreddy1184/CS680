...
public class LinkTest {
    ...
    private String[] linkToStringArray(umbcs680.filesystemcomparator.Link l){
    ...
    private String[] linkTargetFileToStringArray(umbcs680.filesystemcomparator.File f){
    ...
    public void linkCheck(){
        ...
        umbcs680.filesystemcomparator.Link readme = test.getLinks().get(0);
    ...
    public void linkTargetEqualityCheck(){
        ...
        Directory src = repo.getSubDirectories().getFirst();
        Directory test = src.getSubDirectories().get(1);
        umbcs680.filesystemcomparator.File readme = (umbcs680.filesystemcomparator.File) test.getLinks().get(0).getTarget();
