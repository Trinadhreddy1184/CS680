...
public class LinkTest {
    ...
    private static umbcs680.hw08.fs.FileSystem fs;
    ...
    private String[] linkToStringArray(umbcs680.hw08.fs.Link l){
    ...
    private String[] linkTargetFileToStringArray(umbcs680.hw08.fs.File f){
    ...
    public void linkCheck(){
        ...
        umbcs680.hw08.fs.Link readme = test.getLinks().get(0);
    ...
    public void linkTargetEqualityCheck(){
        ...
        Directory src = repo.getSubDirectories().getFirst();
        Directory test = src.getSubDirectories().get(1);
        umbcs680.hw08.fs.File readme = (umbcs680.hw08.fs.File) test.getLinks().get(0).getTarget();
