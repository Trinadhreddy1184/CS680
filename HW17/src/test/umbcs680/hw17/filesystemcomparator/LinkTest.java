...
public class LinkTest {
    ...
    private static umbcs680.hw17.filesystemcomparator.FileSystem fs;
    ...
    private String[] linkToStringArray(umbcs680.hw17.filesystemcomparator.Link l){
    ...
    private String[] linkTargetFileToStringArray(umbcs680.hw17.filesystemcomparator.File f){
    ...
    public void linkCheck(){
        ...
        umbcs680.hw17.filesystemcomparator.Link readme = test.getLinks().get(0);
        assertFalse(readme.isDirectory());
    }

    @Test
    public void linkEqualityCheck(){
        String[] expectedLinkInfo = {"rm.md","0","readme.md","2022-04-24T23:15","test"};
        Directory repo = fs.getRootDirs().getFirst();;
        Directory src = repo.getSubDirectories().getFirst();
        Directory test = src.getSubDirectories().get(1);
        umbcs680.hw17.filesystemcomparator.Link readme = test.getLinks().get(0);
    ...
    public void linkTargetEqualityCheck(){
        ...
        Directory src = repo.getSubDirectories().getFirst();
        Directory test = src.getSubDirectories().get(1);
        umbcs680.hw17.filesystemcomparator.File readme = (umbcs680.hw17.filesystemcomparator.File) test.getLinks().get(0).getTarget();
