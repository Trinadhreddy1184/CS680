...
public class Directory extends FSElement{
    ...
    private  LinkedList<umbcs680.filesystem.Link> links;
    public Directory(Directory parent,String name, int size,LocalDateTime creationTime){
        ...
        links = new LinkedList<umbcs680.filesystem.Link>();
    }
    ...
    public void appendChild(FSElement child){
        ...
        }else if (child instanceof umbcs680.filesystem.Link ) {
            links.add((umbcs680.filesystem.Link) child);
        }
        else{
    ...
    public void removeChild(FSElement child){
        if (child.isDirectory()) {
            ...
            links.remove((umbcs680.filesystem.Link) child);
        } else {
    ...
    public LinkedList<umbcs680.filesystem.Link> getLinks() {
        return this.links;
    }
}